...
if __name__ == "__main__":
    ...
    ana = Analysis('/exp/icarus/app/users/nabrego/medulla_dev/medulla/analysis/nue_plots_reco.toml', '/exp/icarus/app/users/nabrego/dirWork/medulla/build/output_nueCCInclusive_sys.root')

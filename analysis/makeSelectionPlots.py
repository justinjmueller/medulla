...
if __name__ == "__main__":
    ...
    ana = Analysis('/exp/icarus/app/users/nabrego/medulla_dev/medulla/analysis/systematics.toml', '/exp/icarus/app/users/nabrego/dirWork/medulla/build/output_nueCCInclusive_sys.root')
